...
/***/ function(module, exports) {
	...
	var update = function update(_ref, delta, canvas) {
	    ...
	    if (position[0] < 0) position[0] = canvas.width;else if (position[0] > canvas.width) position[0] = 0;
	
	    if (position[1] < 0) position[1] = canvas.height;else if (position[1] < canvas.height) position[1] = 0;

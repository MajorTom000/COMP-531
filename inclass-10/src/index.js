...
class ToDoItem extends React.Component {
    ...
    render() { 
        ...
        <li id={this.props.id}>
            ...
            <i className="destroy glyphicon glyphicon-remove" onClick={()=>this.props.list.removeTodo(this.props.id)} />
        </li>
        /*
...
class ToDos extends React.Component {
    ...
    render() { return (
        ...
        <div>
            ...
            <ul className="todo">
                {this.state.todoItems.map((x,i)=><ToDoItem id={x.id} text={x.text} list={this} key={i}/>)}
            </ul>
        </div>
        /*
        h("div", { },
